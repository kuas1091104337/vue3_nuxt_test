import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, ref, defineComponent, unref, h, Suspense, nextTick, mergeProps, provide, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { j as createHooks, k as getContext, f as createError$1, t as toRouteMatcher, l as createRouter, m as defu, n as hasProtocol, o as joinURL, w as withQuery, s as sanitizeStatusCode, q as isScriptProtocol, v as executeAsync, x as defuFn, y as klona } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "vip",
    path: "/vip",
    component: () => import('./vip.vue.mjs')
  },
  {
    name: (_a = __nuxt_page_meta$3) == null ? void 0 : _a.name,
    path: "/game",
    component: () => import('./game.vue.mjs'),
    children: [
      {
        name: "game-a",
        path: "a",
        component: () => import('./a.vue.mjs')
      },
      {
        name: "game-b",
        path: "b",
        component: () => import('./b.vue.mjs')
      },
      {
        name: "game-id",
        path: ":id()",
  ...
  },
  {
    name: "apiCORS",
    path: "/apiCORS",
    component: () => import('./apiCORS.vue.mjs')
  },
  {
    name: "apiTest",
    path: "/apiTest",
    component: () => import('./apiTest.vue.mjs')
  },
  {
    name: (_b = __nuxt_page_meta) == null ? void 0 : _b.name,
    path: "/courses",
    component: () => import('./courses.vue.mjs'),
    children: [
      {
        name: "courses",
        path: "",
      ...
      {
        name: (_c = __nuxt_page_meta$1) == null ? void 0 : _c.name,
        path: ":courses()",
        component: () => import('./_courses_.vue.mjs'),
        children: [
          {
            name: "courses-courses-A",
            path: "A",
            component: () => import('./A.vue2.mjs')
          },
          {
            name: "courses-courses-B",
            path: "B",
            component: () => import('./B.vue2.mjs')
          },
          {
            name: "courses-courses-C",
            path: "C",
  ...
  },
  {
    name: "mongodb",
    path: "/mongodb",
    component: () => import('./mongodb.vue.mjs')
  },
  {
    name: "slug",
    path: "/:slug(.*)*",
  ...
  },
  {
    name: "dialogTest",
    path: "/dialogTest",
    component: () => import('./dialogTest.vue.mjs')
  },
  {
    name: "githubRepo",
    path: "/githubRepo",
    component: () => import('./githubRepo.vue.mjs')
  },
  {
    name: "computeSetTest",
    path: "/computeSetTest",
    component: () => import('./computeSetTest.vue.mjs')
  }
];
...
const check_45global = defineNuxtRouteMiddleware((to, from) => {
...
const LazyBoxBtn = defineAsyncComponent(() => import('./Btn.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyBox = defineAsyncComponent(() => import('./index.vue22.mjs').then((r) => r["default"] || r.default || r));

const LazyCardList = defineAsyncComponent(() => import('./CardList.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyDialog = defineAsyncComponent(() => import('./index.vue23.mjs').then((r) => r["default"] || r.default || r));

const LazyHome = defineAsyncComponent(() => import('./Home.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyLoading = defineAsyncComponent(() => import('./Loading.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyReposList = defineAsyncComponent(() => import('./ReposList.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazySvgIcon = defineAsyncComponent(() => import('./SvgIcon.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyUserTitle = defineAsyncComponent(() => import('./UserTitle.vue2.mjs').then(function (n) { return n.U; }).then((r) => r["default"] || r.default || r));

const LazyVoteBtn = defineAsyncComponent(() => import('./VoteBtn.vue2.mjs').then((r) => r["default"] || r.default || r));

const LazyVoteCard = defineAsyncComponent(() => import('./voteCard.vue2.mjs').then((r) => r["default"] || r.default || r));
...
const lazyGlobalComponents = [
  ...
  ["Home", LazyHome],
  ["Loading", LazyLoading],
  ["ReposList", LazyReposList],
  ["SvgIcon", LazySvgIcon],
  ["UserTitle", LazyUserTitle],
  ["VoteBtn", LazyVoteBtn],
  ["VoteCard", LazyVoteCard],
  ["Icon", LazyIcon]
];
...
const calendar_LFghU2FyvGKro4ipUaOFWtFEiRiVx03zgHXxc6X0yrs = defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(VCalendar);
});

const test_server_kabCGIRm2nL3exXiQAF1KzbjHQZ_sGO4nf5wnDeDOiE = defineNuxtPlugin((nuxtApp) => {
  console.log("server test");
});

const timeformat_DBHtVf4fpfYBBf_oSY_y3swn_M3Q6ClnyNGrakr5T_Q = defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.directive("timeformat", {
    mounted(el, binding) {
      console.log(el, binding.value);
      el.innerText = dayjs(binding.value).format("YYYY年MM月DD日 HH時mm分ss秒");
    }
  });
});
...
const plugins = [
  ...
  test_server_kabCGIRm2nL3exXiQAF1KzbjHQZ_sGO4nf5wnDeDOiE,
  timeformat_DBHtVf4fpfYBBf_oSY_y3swn_M3Q6ClnyNGrakr5T_Q
];
...
export { _export_sfc as _, __nuxt_component_1 as a, useRoute as b, useRouter as c, useRuntimeConfig as d, useNuxtApp as e, nuxtLinkDefaults as f, fetchDefaults as g, asyncDataDefaults as h, createError as i, defineNuxtRouteMiddleware as j, useAppConfig as k, navigateTo as n, resolveRouteObject as r, server as s, useHead as u };
